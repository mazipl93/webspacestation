...
## 0d. Placeholdery menu „Odkrywaj”

`/starty`, `/kalendarz`, `/mapa`, `/galeria`, `/wideo` → `ComingSoon.tsx` — badge „Wkrótce”. **Do zbudowania** (backlog krok 5–6).
...
| `/starty` | `app/starty/page.tsx` | **Brak** — `ComingSoon` |
| `/kalendarz` | `app/kalendarz/page.tsx` | **Brak** — `ComingSoon` |
| `/mapa` | `app/mapa/page.tsx` | **Brak** — `ComingSoon` |
| `/galeria` | `app/galeria/page.tsx` | **Brak** — `ComingSoon` |
| `/wideo` | `app/wideo/page.tsx` | **Brak** — `ComingSoon` |
