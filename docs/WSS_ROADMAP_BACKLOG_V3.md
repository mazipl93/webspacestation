...
| **5** | **ODKRYWAJ-SECTIONS** | /starty, /mapa, /kalendarz, /galeria, /wideo — real content + API | `[x]` `a069877` |
| **6** | **OPS-API** | Homepage ops z API (nie LAUNCHES[] mock) | `[x]` `a069877` |
