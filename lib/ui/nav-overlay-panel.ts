...
/** Below fixed navbar (h-28), full width with safe gutters on small screens. */
export const NAV_OVERLAY_PANEL_POSITION =
  "max-sm:fixed max-sm:inset-x-4 max-sm:top-[calc(7rem+0.5rem)] max-sm:w-auto max-sm:max-w-none max-sm:origin-top sm:absolute sm:right-0 sm:top-full sm:mt-2 sm:origin-top-right";
