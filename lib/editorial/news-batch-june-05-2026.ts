...
export const EDITORIAL_NEWS_BATCH_JUNE_05_2026: EditorialDraft[] = [
  ...
  {
    slug: "kerbal-space-program-2-eksploracja-2026-update",
    title:
      "Kerbal Space Program 2 w 2026: studio domyka tryb kolonii i uczy rakiet w praktyce",
    subtitle:
      "KSP2 po burzliwym starcie skupia się na stabilności i treści — dla WSS to most między grą a prawdziwymi misjami Falcon i SLS.",
    excerpt:
      "Kerbal Space Program 2 od Private Division / Intercept Games w 2026 roku rozwija tryby budowy kolonii i eksploracji Układu Kerbalów z naciskiem na fizykę orbitalną. To narzędzie edukacyjne dla entuzjastów kosmosu obok newsów o prawdziwych startach Starlink i Artemis.",
    content: [
      "Kerbal Space Program 2 (KSP2) to kontynuacja kultowej symulacji Kerbal Space Program (2015), w której gracz buduje rakiety z części, planuje manewry Hohmann i ląduje na Księżycu Kerbalów — z humorem, ale z realną fizyką Newtona pod spodem.",
      "Po premierze w 2023 studio Intercept Games i wydawca Private Division przechodzili przez patche stabilności i ograniczanie zakresu funkcji; w 2026 roadmapa komunikowana społeczności Steam koncentruje się na koloniach, wielu etapach rakiet i UI budowy — odpowiedź na feedback, że gra musi być grywalna, nie tylko obiecująca.",
      "Dla edukacji kosmicznej KSP2 pozostaje unikalny: gracz widzi, dlaczego ascent z atmosfery zużywa paliwo, czemu docking wymaga dopasowania płaszczyzn orbitalnych i jak transfer do Duna (marsjański odpowiednik) wygląda w liczbach delta-v. To te same pojęcia, które w newsroomie WSS opisujemy przy Falcon 9, SLS i Europa Clipper — tylko w trybie sandbox.",
      "Porównanie z No Man’s Sky (The Swarm, 27 maja 2026): NMS to proceduralna eksploracja miliardów planet bez realnej orbity; KSP2 to orbit-first — najpierw rakieta, potem cel. Oba tytuły siedzą w Technologiach, ale dla różnych typów czytelników.",
      "Społeczność modderska KSP1 przez lata tworzyła realistyczne części (Falcon 9, Apollo) — KSP2 ma trudniejszy ekosystem modów, ale oficjalne części zbliżają się do współczesnych nośników. Dla szkół i planetariów KSP nadal jest rekomendowany jako wprowadzenie do Tsiolkowskiego przed fizyką licealną.",
      "W 2026 Steam i fora raportują poprawę FPS i mniej crashy przy dużych statkach — krytyczne, bo KSP2 bez płynności nie służy nauce. Private Division nie konkuruje z AAA kosmicznymi shooterami; to nisza engineering fantasy.",
      "Powiązanie z prawdziwymi newsami: gdy Starlink 10-43 startuje 4 czerwca, gracz KSP może zbudować Falcon-like i zrozumieć, dlaczego SLC-40 i ASOG mają znaczenie — WSS nie miesza faktów z grą w jednym zdaniu, ale zachęca do eksperymentu po lekturze artykułu.",
      "Artemis i Gateway w realnym świecie mają odpowiednik w planowanych treściach KSP2 (kolonie, stacje); opóźnienia gry odzwierciedlają opóźnienia programów kosmicznych — metafora dla czytelnika.",
      "Cena i dostępność: KSP2 bywa w promocjach Steam; nie jest free-to-play jak część MMO w tej partii (EVE Frontier). Dla redakcji to technologia edukacyjna, nie źródło faktów orbitalnych.",
      "Źródło: komunikaty Intercept / Steam patch notes; okładka NASA (KSC) jako metafora launch. Kategoria Technologie; REVIEW do publikacji końcowej.",
    ].join("\n\n"),
    contextNote:
      "KSP2 na WSS to sektor edukacji przez zabawę — łączy młodszych czytelników z artykułami o prawdziwych startach bez mylenia symulacji z telemetryją SpaceX.",
    ...
    coverImage: nasaCoverUrl("PIA25601"),
    coverImageCredit: "NASA",
    source: "Intercept Games / Steam",
    originalUrl: "https://www.kerbalspaceprogram.com/",
    readingTime: 9,
  },
  {
