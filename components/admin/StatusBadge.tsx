...
> = {
  ...
  REVIEW: { label: "Do akceptacji", className: "text-accent-amber border-accent-amber/30 bg-accent-amber/10" },
  PUBLISHED: { label: "Opublikowany", className: "text-emerald-300 border-emerald-500/30 bg-emerald-500/10" },
